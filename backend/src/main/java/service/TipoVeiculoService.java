...
public class TipoVeiculoService {
    ...
    public void validarTipoVeiculo(TipoVeiculo tipoVeiculo) throws Exception {
        if(tipoVeiculo.getNome() == null || tipoVeiculo.getNome() == "") throw new Exception("Tipo veiculo invalido");
    }
}
